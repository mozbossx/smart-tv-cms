...
if (isset($_GET['promaterial_id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $display_time = $promaterials['display_time'];
        $tv_display = $promaterials['tv_display'];
        $media_path = $promaterials['media_path'];
    } else {
        $media_path = '';
    }
}
...
<head>
    ...
    <title>Edit Promotional Material</title>
</head>
<body>
    ...
    <script>
        const form = document.getElementById('editPromaterialForm');
        ...
        function validateAndOpenPreviewModal() {
            var media = document.querySelector('[name="media"]').value;
            ...
            if (media.trim() === "" || displayTime === "" || tvDisplay === "" || expirationDate === "" || expirationTime === "") {
        ...
        window.onload = function() {
            var mediaPath = '<?php echo $media_path ? "servers/promaterials_media/" . $media_path : ""; ?>';
