                        ...
                        <form id="newsForm" enctype="multipart/form-data" class="main-form">
                            ...
                            <div class="floating-label-container">
                                <div id="quillEditorContainer">
                                    <label for="quillEditorContainer" style="position: absolute; z-index: 10; top: 50px; left: 16px; color: #264B2B; font-size: 12px; font-weight: bold">News</label>
                                    <div id="news_body" style="height: 150px;"></div>
                                </div>
                                <input type="hidden" name="news_body" id="newsBodyHiddenInput">
                            </div>
