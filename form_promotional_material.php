...
<body>
        ...
        <div class="main-container">
            <div class="column1">
                <div class="content-inside-form">
                    <h1 class="content-title" style="color: black"><i class="fa fa-object-group" style="padding-right: 5px"></i>Promotional Material</h1>
                    <div class="content-form">
                        <form id="promaterialForm" enctype="multipart/form-data">
    ...
    <script>
        ...
        const form = document.getElementById('promaterialForm');
