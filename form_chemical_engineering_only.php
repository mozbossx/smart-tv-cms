...
<head>
    ...
    <title>Create an chemical engineering only</title>
</head>
<body>
                    ...
                    <div class="content-form">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb" style="background: none">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">chemical engineering only Form</li>
                            </ol>
                        </nav>
                        <form id="chemical_engineering_onlyForm" enctype="multipart/form-data" class="main-form">
                            <?php include('error_message.php'); ?>
                            <input type="hidden" name="type" value="chemical_engineering_only">
                            <h1 style="text-align: center">chemical engineering only Form</h1>
                            
                <div class="floating-label-container">
                    <div id="quillEditorContainer_text_here" class="quill-editor-container-newfeature">
                        <label for="quillEditorContainer_text_here" style="position: absolute; z-index: 10; top: 50px; left: 16px; color: #264B2B; font-size: 12px; font-weight: bold">Text here</label>
                        <div id="text_here" style="height: 150px;"></div>
                    </div>
                    <input type="hidden" name="text_here" id="text_hereHiddenInput">
                </div>
                            <div class="form-row">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        var text_hereQuill = new Quill('#text_here', {
                                            theme: 'snow',
            ...
            const form = document.getElementById('chemical_engineering_onlyForm');
